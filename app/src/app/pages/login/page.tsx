...
function LoginInner() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setError('');
        setSubmitting(true);
        toast.show('success', `${userName} さんとしてログインしました`);
                ...
                <section className="rounded-2xl border border-background-200 bg-background-50 overflow-hidden shadow-soft">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        <Field label="ユーザー名" required htmlFor="login-username">
                            <Input id="login-username" name="userName" value={userName} onChange={(e) => setUserName(e.target.value)} placeholder="山田 太郎" autoComplete="username" />
                        </Field>
